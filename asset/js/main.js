...
$(document).on('click', '#tombolPopup', function (e) {
    ...
    Swal.fire({
        icon: 'info',
        title: 'Halo Bocah Ilang',
        text: 'Aku meh takon ro kowe',
        showClass: {
                    ...
                    function () {
                        ...
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                Swal.fire({
                                    title: 'Aku yo sayang banget ro kowe ',
                                    showClass: {
                                        popup: 'animate__animated animate__jackInTheBox'
                                    },
                                    hideClass: {
                                    ...
                                    Swal.queue([{
                                        title: 'Sakpiro sayangmu' + ' ' + nama + ' ' + 'ke aku?',
                                        confirmButtonText: 'Submit',
                                        showCancelButton: true,
                                        text: 'Coba isinen pengen ngerti sepiro sayang mu ke aku',
                                        showClass: {
                                            popup: 'animate__animated animate__jackInTheBox'
                                        },
                                        hideClass: {
                                        ...
                                        preConfirm: function (value) {
                                            Swal.insertQueueStep({
                                                title: 'Makasih sudah sayang ke aku' + ' ' + value + '%',
                                                icon: "info",
                                                showClass: {
                                                    popup: 'animate__animated animate__jackInTheBox'
                                                },
                                        ...
                                        Swal.fire({
                                            title: 'Saiki kangen karo aku gak?',
                                            icon: 'question',
                                            type: 'question',
                                            showClass: {
                                                popup: 'animate__animated animate__jackInTheBox'
                                            ...
                                            if (result.isConfirmed) {
                                                Swal.fire({
                                                    title: 'Podo aku yo kangen karo kowe',
                                                    icon: 'info',
                                                    showClass: {
                                                        popup: 'animate__animated animate__jackInTheBox'
                                                    },
                                ...
                                Swal.fire({
                                    title: 'Beneran? Aku takon pisan maneh. Sayang gak karo aku?',
                                    icon: 'question',
                                    text: 'Cobo jawab sing bener',
                                    showCancelButton: true,
                                    ...
                                    if (result.isConfirmed) {
                                        ...
                                        Swal.fire({
                                            title: 'Aku yo sayang banget karo kowe '
                                        }).then(() => {
                                            Swal.queue([{
                                                title: 'Sakpiro sayangmu ke aku?',
                                                confirmButtonText: 'Submit',
                                                showCancelButton: true,
                                                text: 'Cobo isi aku pengen ngerti sekpiro sayangmu ke aku',
                                                showClass: {
                                                    popup: 'animate__animated animate__jackInTheBox'
                                                },
                                                hideClass: {
